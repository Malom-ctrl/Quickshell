...
Rectangle {
    id: root
    height: 40
    color: Globals.activeColors.primaryContainer // Primary Container
    radius: 20
    ...
    RowLayout {
        ...
        Rectangle {
            width: 28; height: 28
            radius: 14
            color: Globals.activeColors.primary // Primary
            Icon {
                width: 16; height: 16
                anchors.centerIn: parent
                path: "M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"
                color: Globals.activeColors.onPrimary // On Primary
            }
        }
        ...
        Item {
            ...
            Text {
                id: mediaText
                text: root.title
                color: Globals.activeColors.onPrimaryContainer // On Primary Container
                font.pixelSize: 15
                font.bold: true
        ...
        RowLayout {
            ...
            MouseArea {
                ...
                Icon { anchors.centerIn: parent; width: 20; height: 20; path: "M6 6h2v12H6zm3.5 6l8.5 6V6z"; color: Globals.activeColors.onPrimaryContainer }
            }
            MouseArea {
                implicitWidth: 32; implicitHeight: 32
                onClicked: if (root.player && root.player.canTogglePlaying) root.player.togglePlaying()
                Rectangle {
                    anchors.fill: parent; radius: 16; color: Globals.activeColors.primary
                    Icon {
            ...
            MouseArea {
                ...
                Icon { anchors.centerIn: parent; width: 20; height: 20; path: "M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"; color: Globals.activeColors.onPrimaryContainer }
            }
        }
    }
}
