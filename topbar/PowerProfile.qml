...
Rectangle {
    ...
    property color dialColor: {
        if (profile === PowerProfile.Performance) return Globals.activeColors.Warning // Red
        if (profile === PowerProfile.PowerSaver) return Globals.activeColors.Success // Green
        return Globals.activeColors.Secondary // Blue / Light purple
    }
    ...
    Rectangle {
        ...
        width: 14; height: 14
        radius: 7
        color: Globals.activeColors.Warning // Error color
