...
Rectangle {
    id: root
    property string themeScope: "topbar.PowerProfile"
    ...
    color: Qt.rgba(root.dialColor.r, root.dialColor.g, root.dialColor.b, Globals.customValue(themeScope, "opacity", 0.2))
    ...
    property color dialColor: {
        if (profile === PowerProfile.Performance) return Globals.customValue(themeScope, "performanceColor", Globals.themeVars.Warning) // Red
        if (profile === PowerProfile.PowerSaver) return Globals.customValue(themeScope, "powerSaverColor", Globals.themeVars.Success) // Green
        return Globals.customValue(themeScope, "balancedColor", Globals.themeVars.Secondary) // Blue / Light purple
    }
    ...
    Rectangle {
        ...
        Icon {
            anchors.centerIn: parent
            width: Globals.customValue(themeScope + ".warning.icon", "width", 10); height: Globals.customValue(themeScope + ".warning.icon", "height", 10)
            color: Globals.customValue(themeScope + ".warning.icon", "color", Globals.themeVars.Black)
