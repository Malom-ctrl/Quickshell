...
Rectangle {
    id: root
    property string themeScope: "topbar.ThemeWidget"
    ...
    color: (mouseArea.containsMouse || popup.isActive) ? Globals.customValue(themeScope, "hoverColor", Globals.themeVars.Secondary25) : Globals.customValue(themeScope, "color", Globals.themeVars.Secondary10)
