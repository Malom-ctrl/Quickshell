...
PopupWindow {
    ...
    property string themeScope: "topbar.AudioPopup"
    ...
    Item {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Item { height: Globals.customValue(themeScope + ".popup.layout", "topPadding", 4); Layout.fillWidth: true } // top padding

                // OUTPUT
                ColumnLayout {
                    spacing: Globals.customValue(themeScope + ".popup.section", "spacing", Globals.themeVars.spacingLarge)
                    Layout.fillWidth: true

                    RowLayout {
                        Layout.fillWidth: true
                        spacing: Globals.customValue(themeScope + ".popup.section.header", "spacing", Globals.themeVars.spacingLarge)

                        Icon {
                            width: Globals.customValue(themeScope + ".popup.section.icon", "width", 20); height: Globals.customValue(themeScope + ".popup.section.icon", "height", 20)
                            ...
                            color: Globals.customValue(themeScope + ".popup.section.icon", "color", Globals.themeVars.White)
                        }

                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: Globals.customValue(themeScope + ".popup.section.text", "spacing", 0)

                            RowLayout {
                                Layout.fillWidth: true
                                Text {
                                    text: "Output"
                                    color: Globals.customValue(themeScope + ".popup.section.title", "color", Globals.themeVars.White)
                                    font.pixelSize: Globals.customValue(themeScope + ".popup.section.title", "fontSize", Globals.themeVars.fontSizeMedium)
                                    font.bold: true
                                    Layout.fillWidth: true
                                }
                                Text {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        font.pixelSize: Globals.customValue(themeScope + ".popup.section.device.text", "fontSize", Globals.themeVars.fontSizeSmall)
                                        Layout.fillWidth: true
                                        elide: Text.ElideRight
                                    }
                                    Icon {
                                        visible: audioPopup.sinks.length > 1
                                        width: Globals.customValue(themeScope + ".popup.section.device.icon", "width", 14); height: Globals.customValue(themeScope + ".popup.section.device.icon", "height", 14)
                                        path: "M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"
                                        color: Globals.customValue(themeScope + ".popup.section.device.icon", "color", Globals.themeVars.SecondaryLight)
                                    }
                                }
                ...
                ColumnLayout {
                    spacing: Globals.customValue(themeScope + ".popup.section", "spacing", Globals.themeVars.spacingLarge)
                    Layout.fillWidth: true
                    Layout.topMargin: Globals.customValue(themeScope + ".popup.section", "topMargin", Globals.themeVars.spacingMedium)
                ...
                Item { height: Globals.customValue(themeScope + ".popup.layout", "bottomPadding", 4); Layout.fillWidth: true } // bottom padding
            }
        }
    }
}
