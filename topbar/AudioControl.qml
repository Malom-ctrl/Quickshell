...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        radius: 20
        color: root.popupVisible ? Globals.activeColors.primary : Globals.activeColors.secondaryContainer
        ...
        Shape {
            ...
            ShapePath {
                ...
                strokeColor: root.popupVisible ? Globals.activeColors.onPrimary : Globals.activeColors.primary
                strokeWidth: 2
        ...
        Icon {
            ...
            width: 16; height: 16 // make icon slightly smaller to fit the circle border
            ...
            color: root.popupVisible ? Globals.activeColors.onPrimary : Globals.activeColors.onSecondaryContainer
        }
