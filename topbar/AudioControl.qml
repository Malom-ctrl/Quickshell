...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        radius: 20
        color: (mouseArea.containsMouse || root.popupVisible) ? Globals.activeColors.Secondary50 : Globals.activeColors.Secondary25
        ...
        Shape {
            ...
            ShapePath {
                ...
                strokeColor: (mouseArea.containsMouse || root.popupVisible) ? Globals.activeColors.White : Globals.activeColors.Secondary
                strokeWidth: 2
